 ...
 *  intraspecific
 *
 *  Created by Martin Köchy on Sat May 03 2003.
...
//  maxGerm = 0.72; // Tielbörger exp., 0.95 Marcelo pers. comm.
  ActivityV	=  0.05;	// ±0.0
}
...
//  maxGerm = 0.98; // 0.98 Tielbörger exp., 0.98 Marcelo exp.
	ActivityV	=  0.05;	// ±0.0
}
...
//  maxGerm = 0.53; // Tielbörger exp., 0.75 Marcelo exp.
	ActivityV	=  0.02;	// ±0.0
}
...
//  maxGerm = 0.40; // Tielbörger exp., 0.86 Marcelo exp.
	ActivityV	=  0.05;	// ±0.0
}
...
//  maxGerm = 0.13; // Tielbörger exp., 0.48 Marcelo exp.
	ActivityV	=  0.01;	// ±0.0
}
...
//  maxGerm = 0.80; // Tielbörger exp., 0.9 Marcelo exp.
	ActivityV	=  0.05;	// ±0.0
}
...
//  maxGerm = 0.76; // Tielbörger exp., 0.98 Marcelo exp.
	ActivityV	=  0.05;	// ±0.0
}
